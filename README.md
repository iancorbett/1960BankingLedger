...
The Ledger lets users securely log in, track transactions, and visualize their balances — styled like an old-school checkbook but powered by ASP.NET Core, EF Core, and PostgreSQL.
